...
const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  'gravação e transcrição de áudio com uso justo de até 20 horas por mês': 'Grave ou envie áudios clínicos e transcreva até 1.200 minutos por mês. Evoluções do Trial e plano mensal aceitam até 20 minutos; no plano anual, até 60 minutos.',
  ...
  'gravação e transcrição de áudio nativa': 'Grave suas sessões ou observações direto pelo app. Cada evolução aceita até 20 minutos no Trial e plano mensal, ou até 60 minutos no plano anual.',
  ...
  'controle de sessões com assinatura e fechamento mensal': 'Organize os atendimentos do paciente, registre assinaturas e feche cada mês com exportação em PDF no Plano Anual.',
