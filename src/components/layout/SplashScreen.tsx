  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-6">
      <div className="w-full max-w-sm rounded-[2rem] border border-brand-border bg-white shadow-2xl shadow-brand-primary/10 px-8 py-10 text-center space-y-6">
        {splashLogoUrl ? (
          <div className="rounded-[1.75rem] border border-brand-primary/10 bg-brand-primary/5 px-6 py-6 shadow-lg shadow-brand-primary/5">
            <div className="rounded-[1.25rem] bg-white/90 px-5 py-4">
              <img
                src={splashLogoUrl}
