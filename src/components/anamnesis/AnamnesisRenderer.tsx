...
function FieldInput({ field, value, disabled, onChange }: { field: AnamnesisField; value: AnamnesisAnswers[string]; disabled: boolean; onChange: (value: AnamnesisAnswers[string]) => void }) {
