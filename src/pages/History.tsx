                          ...
                          <>
                            ...
                            <div className="absolute right-0 top-9 w-52 bg-white border border-brand-border rounded-xl shadow-lg py-1.5 z-20 animate-in fade-in slide-in-from-top-1 duration-150">
                              ...
                              <Link
                                ...
                                onClick={() => setActiveDropdownId(null)}
                                className="w-full text-left px-4 py-2 text-xs text-brand-text hover:bg-brand-bg flex items-center space-x-2 transition-colors cursor-pointer font-medium border-t border-brand-border/40 mt-1 pt-1.5"
                              >
