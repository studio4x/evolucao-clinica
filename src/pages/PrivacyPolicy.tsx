        ...
        <div className="prose prose-slate max-w-none text-brand-text space-y-6 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              qualquer uma a qualquer momento pelo botão flutuante <strong>Privacidade e cookies</strong> nas páginas públicas do site ou, dentro do painel, na página <strong>Sobre o app</strong>, pela opção <strong>Preferências de privacidade</strong>.
