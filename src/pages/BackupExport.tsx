...
import { AlertCircle, AlertTriangle, CheckCircle, Cloud, Database, Download, Loader2, Lock, RefreshCcw, ShieldAlert, Sparkles } from 'lucide-react';
        ...
        <div className="rounded-2xl border border-amber-200/60 bg-gradient-to-br from-amber-50/40 to-orange-50/20 p-5">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div className="max-w-lg space-y-1.5">
              <h2 className="flex items-center gap-2 text-sm font-semibold text-amber-800"><Sparkles size={16} className="text-amber-600" /> Backup Completo e Restauração (Google Drive)</h2>
            ...
            <button type="button" onClick={() => navigate('/painel/subscription')} className="btn-primary shrink-0 cursor-pointer bg-gradient-to-r from-amber-500 to-amber-600 px-4 py-2 text-xs font-semibold text-white shadow-md shadow-amber-500/10 transition-all hover:from-amber-600 hover:to-amber-700 active:scale-95 animate-none">
              Assinar Plano Anual
            </button>
          </div>
        </div>
