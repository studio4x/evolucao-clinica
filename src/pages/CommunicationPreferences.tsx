...
export default function CommunicationPreferences() {
  const [preferences, setPreferences] = useState<Preferences>({ product_education_enabled: true, lifecycle_enabled: true, commercial_enabled: true, preferred_send_time: '08:30', timezone: 'America/Sao_Paulo' });
