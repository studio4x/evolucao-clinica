...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Os pagamentos são processados pela Stripe. Na web, aceitamos cartão, Google Pay e Apple Pay quando compatíveis com o dispositivo. No aplicativo Android distribuído pela Play Store, a Google apresenta as opções de cobrança permitidas. Pix, boleto e Link não são oferecidos."
    },
    {
            ...
            <div className="bg-white rounded-3xl border border-brand-primary/20 p-8 shadow-md space-y-6 relative overflow-hidden">
              ...
              <ul className="space-y-4">
                <li className="flex gap-3 text-sm text-brand-text leading-relaxed">
                  ...
                  <span><strong>Grave até 20 minutos por evolução no Trial e mensal, ou até 60 minutos no anual</strong> e deixe nossa IA transcrever e organizar o registro clínico.</span>
                </li>
                <li className="flex gap-3 text-sm text-brand-text leading-relaxed">
                  <Check size={18} className="text-brand-primary flex-shrink-0 mt-0.5" />
              ...
              return (
                <div key={plan.id} className="flex flex-col items-center gap-3.5 w-full h-full">
                  ...
                  <div className="flex items-center justify-center gap-2 text-xs text-brand-text-muted select-none mt-1">
                    ...
                    <span>Pagamento seguro com Stripe, Google Pay ou Apple Pay</span>
                  </div>
                </div>
              );
            })}
      ...
      <footer className="bg-brand-bg border-t border-brand-border py-12 text-center text-xs text-brand-text-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <p className="max-w-2xl mx-auto">
            Evolução Clínica é uma plataforma desenvolvida e operada por
            <br className="hidden md:inline" />
            {" "}"RODOLFO J M LOPES SERVIÇOS DIGITAIS - STUDIO 4X",
            <br className="hidden md:inline" />
            {" "}inscrita no CNPJ sob o nº 10.682.236/0001-09.
          </p>
          <p>
            Contato oficial:{' '}
