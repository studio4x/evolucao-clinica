          ...
          {customLogoUrl && (
            ...
            {showCropEditor && (
              <ImageCropEditor
                ...
                title="Enquadramento do logotipo"
                description="Arraste a imagem para definir a posição do corte. O arquivo final será salvo em PNG, pronto para o cabeçalho."
                imageAlt="Editor de recorte do logotipo"
                onApply={handleApplyCrop}
                onError={(error) => showAlert(`Erro ao aplicar o recorte: ${error instanceof Error ? error.message : error}`, { title: 'Erro no Recorte', variant: 'danger', icon: 'warning' })}
                applying={uploadingLogo}
              />
            )}
