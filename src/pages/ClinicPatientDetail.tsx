...
export default function ClinicPatientDetail() {
  ...
  return <div className="patient-mobile-swipe-surface space-y-6">
    ...
    <PatientDetailGrid>
      <div id="patient-tabpanel-overview" role="tabpanel" aria-labelledby="patient-tab-overview" className={`${tabVisibility("overview")} grid xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,1fr)] xl:col-span-2 xl:gap-6`}>
