...
export default function ClinicInvitationAccept() {
  ...
  return <main className="mx-auto max-w-lg p-6 text-[#105576]">
    ...
    {isAuthReady && !info && <button type="button" className="mt-4 rounded border border-[#105576] p-3 text-[#105576] transition hover:bg-white disabled:opacity-50" disabled={busy} onClick={() => void logout()}>Sair e acessar com outra conta</button>}
  </main>;
}
