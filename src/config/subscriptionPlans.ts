...
export const PLAY_CONSOLE_MONTHLY_BENEFITS = [
  'Pacientes e prontuários ilimitados',
  'Transcrição de áudio com IA',
  'Relatórios e pesquisa clínica por IA',
  'Google Docs, assinatura e PDFs'
];

export const PLAY_CONSOLE_YEARLY_BENEFITS = [
  'Tudo do Plano Mensal',
  'Migração assistida de prontuários',
  'Backup e restauração no Google Drive',
  'Logotipo e suporte VIP em até 2h'
];
