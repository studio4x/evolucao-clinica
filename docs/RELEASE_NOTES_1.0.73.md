# Notas da versão 1.0.73

Data: 06/08/2026  
Android: 1.0.73 (versionCode 73)  
Build web: v1.10.721

## Novidades e correções

- Corrigido o recebimento de áudios compartilhados pelo WhatsApp no aplicativo Android.
- Melhorado o reconhecimento de notas de voz nos formatos Ogg/Opus, mesmo quando o WhatsApp informa um tipo de arquivo genérico.
- A duração não identificada pelo player do celular não bloqueia mais o processamento da evolução.
- A tela de áudio recebido agora informa quando falta selecionar o paciente antes de iniciar o processamento.
