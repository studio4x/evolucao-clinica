...
assert.match(routeSnippet, /organization_memberships/);
assert.match(routeSnippet, /membershipsByProfessional/);
assert.match(routeSnippet, /clinics: membershipsByProfessional/);
assert.doesNotMatch(routeSnippet, /for \(const professional of rows/);
assert.doesNotMatch(routeSnippet, /patients|evolutions|anamnese|transcription/i);
