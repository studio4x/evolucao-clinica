...
assert.match(componentSource, /professional-funnel-fullscreen-toggle/);
assert.match(componentSource, /Voltar à exibição normal/);
assert.match(componentSource, /data-fullscreen/);
