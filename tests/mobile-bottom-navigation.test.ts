...
assert.match(gradleSource, /versionCode 93/);
assert.match(gradleSource, /versionName "93"/);
assert.match(twaManifestSource, /"appVersionCode": 93/);
assert.match(twaManifestSource, /"appVersionName": "93"/);
assert.match(twaManifestSource, /"appVersion": "93"/);
