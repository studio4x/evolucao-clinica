...
const FALLBACK_RULE_MESSAGES: Record<string, Record<string, unknown>> = {
  ...
  trial_canceled_reengagement_3d: { subject: "Ganhe mais 7 dias para conhecer o Evolução Clínica", preheader: "Ative uma nova semana gratuita para experimentar a plataforma com mais calma.", body: "Queremos que você tenha mais tempo para conhecer o que o Evolução Clínica pode fazer pela sua rotina.\n\nPor isso, preparamos uma extensão gratuita de 7 dias para sua conta. Para ativá-la, clique no botão abaixo e confirme a liberação.\n\nOs 7 dias só começarão a contar depois da sua confirmação.", cta_label: "Ativar mais 7 dias grátis", cta_route: "/reativar-teste", category: "commercial", commercial: true },
